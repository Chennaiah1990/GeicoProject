...
public class ReusableFunction extends Eelement {
	...
	/*public void Multidropdown(WebElement element)
	{
		int number1=0;
		try
		{ if (number1 > number){
			Select multidropdown=new Select(element);
			multidropdown.selectByIndex(number1);
			multidropdown.selectByIndex(number1);
			multidropdown.selectByIndex(number1);
		}
		else{
			Select multidropdown=new Select(element);
			multidropdown.selectByVisibleText(value1);
			multidropdown.selectByVisibleText(value2);
			multidropdown.selectByVisibleText(value3);
		    }}
		catch(Exception e)
		{
	...
	/*public void assertSelectionfalse(WebElement element)
	{
		try
		{
